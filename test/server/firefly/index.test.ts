...
import { API_BASE_PATH, PUBLIC_URL } from '../../../src/server/routes';
...
describe('firefly service test', () => {
    test('test fetchResultsLocally', async () => {
        ...
        expect(results.outputs[0].image.presignedUrl.startsWith(`${PUBLIC_URL + API_BASE_PATH}/storage/get?fileName=`)).toBeTruthy();
    })
